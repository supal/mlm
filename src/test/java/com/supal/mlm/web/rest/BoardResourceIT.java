...
class BoardResourceIT {
    ...
    private static final BoardType DEFAULT_TYPE = BoardType.SINGLE;
    private static final BoardType UPDATED_TYPE = BoardType.MULTI;
    ...
    public static Board createEntity(EntityManager em) {
        Board board = new Board().type(DEFAULT_TYPE);
        return board;
    }
    ...
    public static Board createUpdatedEntity(EntityManager em) {
        Board board = new Board().type(UPDATED_TYPE);
        return board;
    }
    ...
    void putNewBoard() throws Exception {
        ...
        updatedBoard.type(UPDATED_TYPE);
    ...
    void partialUpdateBoardWithPatch() throws Exception {
        ...
        partialUpdatedBoard.type(UPDATED_TYPE);
