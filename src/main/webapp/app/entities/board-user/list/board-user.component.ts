...
export class BoardUserComponent implements OnInit {
  ...
  trackId(index: number, item: IBoardUser): number {
    return item.id!;
  }

  delete(boardUser: IBoardUser): void {
    const modalRef = this.modalService.open(BoardUserDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.boardUser = boardUser;
  ...
  protected onSuccess(data: IBoardUser[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
