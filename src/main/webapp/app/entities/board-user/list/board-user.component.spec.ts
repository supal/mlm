...
describe('Component Tests', () => {
  describe('BoardUser Management Component', () => {
    let comp: BoardUserComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BoardUserComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.boardUsers?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
